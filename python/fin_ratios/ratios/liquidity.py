...
def cash_ratio(cash: float, short_term_investments: float, current_liabilities: float) -> Optional[float]:
    """
    Cash Ratio.
...
cash_conversion_cycle.description = "Days from paying for inventory to collecting from customers. Negative = float business."  # type: ignore[attr-defined]
