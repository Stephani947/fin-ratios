...
enterprise_value.description = (
    "Theoretical takeover price — capital-structure-neutral valuation base."  # type: ignore[attr-defined]
)
...
graham_intrinsic_value.description = (
    "Graham's 1974 revised intrinsic value. growth_rate and aaa_bond_yield as percentages."  # type: ignore[attr-defined]
)
