...
debt_service_coverage_ratio.formula = (
    "Net Operating Income / Annual Debt Service (Principal + Interest)"  # type: ignore[attr-defined]
)
debt_service_coverage_ratio.description = (
    "Lenders require > 1.25x. Critical for real estate and LBO deals."  # type: ignore[attr-defined]
)
...
equity_multiplier.description = (
    "Leverage component of DuPont analysis. Higher = more debt-financed."  # type: ignore[attr-defined]
)
