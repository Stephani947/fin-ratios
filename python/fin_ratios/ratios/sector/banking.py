...
provision_coverage_ratio.description = (
    "> 100% = fully reserved. Conservative banks maintain 100-150%."  # type: ignore[attr-defined]
)
...
tangible_book_value_per_share.description = (
    "Conservative book value per share, stripped of acquisition premiums."  # type: ignore[attr-defined]
)
